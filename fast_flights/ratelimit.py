...
The default rates below are arbitrary — Google's threshold isn't published.

Disable with `--no-rate-limit`, `FAST_FLIGHTS_NO_RATE_LIMIT=1`, or
`rate_limit=False`.
"""
...
ENV_DISABLE = "FAST_FLIGHTS_NO_RATE_LIMIT"
BUCKET_NAME = "google-flights"
...
def _default_db_path() -> Path:
    ...
    return base / "fast-flights" / "ratelimit.sqlite"
